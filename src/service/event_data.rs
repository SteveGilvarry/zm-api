...
pub async fn list_all(state: &AppState, event_id: Option<u64>) -> AppResult<Vec<EventDataResponse>> {
...
pub async fn update(state: &AppState, id: u64, req: UpdateEventDataRequest) -> AppResult<EventDataResponse> {
