...
pub async fn list_all(state: &AppState, snapshot_id: Option<u32>, event_id: Option<u64>) -> AppResult<Vec<SnapshotEventResponse>> {
...
pub async fn create(state: &AppState, req: CreateSnapshotEventRequest) -> AppResult<SnapshotEventResponse> {
