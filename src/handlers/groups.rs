...
pub async fn get_group(Path(id): Path<u32>, State(state): State<AppState>) -> AppResult<Json<GroupResponse>> {
...
pub async fn update_group(Path(id): Path<u32>, State(state): State<AppState>, Json(req): Json<UpdateGroupRequest>) -> AppResult<Json<GroupResponse>> {
...
pub async fn create_group(State(state): State<AppState>, Json(req): Json<CreateGroupRequest>) -> AppResult<(axum::http::StatusCode, Json<GroupResponse>)> {
...
pub async fn delete_group(Path(id): Path<u32>, State(state): State<AppState>) -> AppResult<axum::http::StatusCode> {
