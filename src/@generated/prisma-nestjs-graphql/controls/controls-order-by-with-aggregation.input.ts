...
import { ControlsCountOrderByAggregateInput } from './controls-count-order-by-aggregate.input';
import { ControlsAvgOrderByAggregateInput } from './controls-avg-order-by-aggregate.input';
import { ControlsMaxOrderByAggregateInput } from './controls-max-order-by-aggregate.input';
import { ControlsMinOrderByAggregateInput } from './controls-min-order-by-aggregate.input';
import { ControlsSumOrderByAggregateInput } from './controls-sum-order-by-aggregate.input';

@InputType()
export class ControlsOrderByWithAggregationInput {
    ...
    @Field(() => ControlsCountOrderByAggregateInput, {nullable:true})
    _count?: ControlsCountOrderByAggregateInput;

    @Field(() => ControlsAvgOrderByAggregateInput, {nullable:true})
    _avg?: ControlsAvgOrderByAggregateInput;

    @Field(() => ControlsMaxOrderByAggregateInput, {nullable:true})
    _max?: ControlsMaxOrderByAggregateInput;

    @Field(() => ControlsMinOrderByAggregateInput, {nullable:true})
    _min?: ControlsMinOrderByAggregateInput;

    @Field(() => ControlsSumOrderByAggregateInput, {nullable:true})
    _sum?: ControlsSumOrderByAggregateInput;
}
