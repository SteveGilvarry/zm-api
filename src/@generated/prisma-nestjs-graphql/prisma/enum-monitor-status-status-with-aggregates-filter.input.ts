...
import { NestedEnumMonitor_Status_StatusWithAggregatesFilter } from './nested-enum-monitor-status-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMonitor_Status_StatusFilter } from './nested-enum-monitor-status-status-filter.input';

@InputType()
export class EnumMonitor_Status_StatusWithAggregatesFilter {
