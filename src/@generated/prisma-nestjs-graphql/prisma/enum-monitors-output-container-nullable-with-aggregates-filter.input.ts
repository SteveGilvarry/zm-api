...
import { NestedEnumMonitors_OutputContainerNullableWithAggregatesFilter } from './nested-enum-monitors-output-container-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumMonitors_OutputContainerNullableWithAggregatesFilter {
