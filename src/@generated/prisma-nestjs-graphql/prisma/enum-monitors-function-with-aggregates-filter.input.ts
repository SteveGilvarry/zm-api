...
import { NestedEnumMonitors_FunctionWithAggregatesFilter } from './nested-enum-monitors-function-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMonitors_FunctionFilter } from './nested-enum-monitors-function-filter.input';

@InputType()
export class EnumMonitors_FunctionWithAggregatesFilter {
