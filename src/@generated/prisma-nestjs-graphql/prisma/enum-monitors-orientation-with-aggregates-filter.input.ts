...
import { NestedEnumMonitors_OrientationWithAggregatesFilter } from './nested-enum-monitors-orientation-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMonitors_OrientationFilter } from './nested-enum-monitors-orientation-filter.input';

@InputType()
export class EnumMonitors_OrientationWithAggregatesFilter {
