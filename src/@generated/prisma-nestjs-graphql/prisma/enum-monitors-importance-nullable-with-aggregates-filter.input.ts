...
import { NestedEnumMonitors_ImportanceNullableWithAggregatesFilter } from './nested-enum-monitors-importance-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumMonitors_ImportanceNullableWithAggregatesFilter {
