...
import { NestedEnumUsers_SnapshotsWithAggregatesFilter } from './nested-enum-users-snapshots-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUsers_SnapshotsFilter } from './nested-enum-users-snapshots-filter.input';

@InputType()
export class EnumUsers_SnapshotsWithAggregatesFilter {
