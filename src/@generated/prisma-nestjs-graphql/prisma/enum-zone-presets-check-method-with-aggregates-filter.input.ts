...
import { NestedEnumZonePresets_CheckMethodWithAggregatesFilter } from './nested-enum-zone-presets-check-method-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumZonePresets_CheckMethodFilter } from './nested-enum-zone-presets-check-method-filter.input';

@InputType()
export class EnumZonePresets_CheckMethodWithAggregatesFilter {
