...
import { NestedEnumEvents_SchemeWithAggregatesFilter } from './nested-enum-events-scheme-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumEvents_SchemeFilter } from './nested-enum-events-scheme-filter.input';

@InputType()
export class EnumEvents_SchemeWithAggregatesFilter {
