...
import { NestedEnumUsers_EventsWithAggregatesFilter } from './nested-enum-users-events-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUsers_EventsFilter } from './nested-enum-users-events-filter.input';

@InputType()
export class EnumUsers_EventsWithAggregatesFilter {
