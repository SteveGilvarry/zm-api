...
import { NestedEnumFrames_TypeWithAggregatesFilter } from './nested-enum-frames-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumFrames_TypeFilter } from './nested-enum-frames-type-filter.input';

@InputType()
export class EnumFrames_TypeWithAggregatesFilter {
