...
import { NestedEnumUsers_MonitorsWithAggregatesFilter } from './nested-enum-users-monitors-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUsers_MonitorsFilter } from './nested-enum-users-monitors-filter.input';

@InputType()
export class EnumUsers_MonitorsWithAggregatesFilter {
