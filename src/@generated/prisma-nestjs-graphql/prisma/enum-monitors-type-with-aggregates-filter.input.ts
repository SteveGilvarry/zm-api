...
import { NestedEnumMonitors_TypeWithAggregatesFilter } from './nested-enum-monitors-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMonitors_TypeFilter } from './nested-enum-monitors-type-filter.input';

@InputType()
export class EnumMonitors_TypeWithAggregatesFilter {
