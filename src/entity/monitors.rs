...
pub struct Model {
    ...
    pub output_codec: u32,
    #[sea_orm(column_name = "OutputCodecName")]
    pub output_codec_name: String,
    #[sea_orm(column_name = "Encoder")]
    pub encoder: Option<String>,
    #[sea_orm(column_name = "EncoderHWAccelName")]
    pub encoder_hw_accel_name: Option<String>,
    #[sea_orm(column_name = "EncoderHWAccelDevice")]
    ...
    #[sea_orm(column_name = "WallClockTimestamps")]
